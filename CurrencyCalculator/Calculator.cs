...
namespace CurrencyCalculator
{
    ...
    {
	    private List<CurrencyData> CurrencyData { get; }

	    public Calculator()
		{
			// Use the default currency data
		...
		public Calculator(List<CurrencyData> currencyData)
		{
			// use injected data
        ...
        {
			CurrencyData currencyData = CurrencyData.FirstOrDefault(c =>
